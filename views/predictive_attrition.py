...
st.caption("A classification model trained on historical outcomes to flag employee churn risk.")
...
if y.nunique() < 2:
    st.warning("This dataset has no terminated employees to learn from.")
    st.stop()
...
st.markdown("""
    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 5px;">
        ...
        <h3 style="margin: 0; font-family: 'Playfair Display', serif; color: #2A1F4D; font-size: 1.25rem;">What the Model Is Actually Picking Up On</h3>
    </div>
